...
ARG package_url=https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/2025.1/linux/openvino_genai_ubuntu22_2025.1.0.0_x86_64.tar.gz
...
ARG OPENVINO_WHEELS_VERSION=2025.1.0.0
