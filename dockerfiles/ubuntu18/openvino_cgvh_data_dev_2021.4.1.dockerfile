...
COPY dockerfiles/ubuntu18/third-party-programs-docker-data-dev.txt ${INTEL_OPENVINO_DIR}/licensing
COPY dockerfiles/ubuntu18/third-party-programs-docker-data-runtime.txt ${INTEL_OPENVINO_DIR}/licensing
