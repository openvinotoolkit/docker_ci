...
class TestSamplesLinux:
    ...
    def test_hello_classification_cpp_cpu(self, tester, image, install_openvino_dependencies, bash):
    ...
    @pytest.mark.xfail_log(pattern='Error: Download',
                           reason='Network problems when downloading alexnet files')
    def test_hello_classification_cpp_gpu(self, tester, image, install_openvino_dependencies, bash):
    ...
    def test_hello_classification_cpp_fail(self, tester, image, caplog, install_openvino_dependencies, bash):
    ...
    def test_hello_reshape_cpp_cpu(self, tester, image, install_openvino_dependencies, bash):
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
             bash('cd /opt/intel/openvino/inference_engine/samples/cpp && '
    ...
    @pytest.mark.gpu
    def test_hello_reshape_cpp_gpu(self, tester, image, install_openvino_dependencies, bash):
        kwargs = {'devices': ['/dev/dri:/dev/dri'], 'mem_limit': '3g'}
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
    ...
    def test_object_detection_cpp_cpu(self, tester, image, install_openvino_dependencies, bash):
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
             bash('cd /opt/intel/openvino/inference_engine/samples/cpp && '
    ...
    @pytest.mark.gpu
    def test_object_detection_cpp_gpu(self, tester, image, install_openvino_dependencies, bash):
        kwargs = {'devices': ['/dev/dri:/dev/dri'], 'mem_limit': '3g'}
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
    ...
    @pytest.mark.xfail_log(pattern='Error: Download',
                           reason='Network problems when downloading alexnet files')
    def test_classification_async_cpp_cpu(self, tester, image, install_openvino_dependencies, bash):
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
             bash('cd /opt/intel/openvino/inference_engine/samples/cpp && '
    ...
    @pytest.mark.xfail_log(pattern='Error: Download',
                           reason='Network problems when downloading alexnet files')
    def test_classification_async_cpp_gpu(self, tester, image, install_openvino_dependencies, bash):
        kwargs = {'devices': ['/dev/dri:/dev/dri'], 'mem_limit': '3g'}
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
    ...
    def test_benchmark_app_cpp_cpu(self, tester, image, install_openvino_dependencies, bash):
        kwargs = {'mem_limit': '3g'}
        tester.test_docker_image(
            image,
            [install_openvino_dependencies,
