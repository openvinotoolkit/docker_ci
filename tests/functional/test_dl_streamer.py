...
class TestDLStreamerLinux:
    ...
    @pytest.mark.gpu
    def test_draw_face_attributes_cpp_gpu(self, tester, image):
    ...
    def test_draw_face_attributes_cpp_vpu(self, tester, image):
    ...
    @pytest.mark.hddl
    def test_draw_face_attributes_cpp_hddl(self, tester, image):
