...
@pytest.mark.parametrize(('args', 'res'), [
    ...
    pytest.param(
        ...
        {
            'device': ['cpu'],
            'dockerfile_name': 'openvino_c_dev_2022.1.dockerfile',
            'python': 'python38',
    ...
    pytest.param(
        ...
        {
            'device': ['cpu'],
            'dockerfile_name': 'openvino_c_base_2022.1.dockerfile',
            'python': 'python36',
            'tags': ['ubuntu18_base_cpu:2022.1', 'ubuntu18_base_cpu:latest'],
            'distribution': 'base',
            'product_version': '2022.1',
        },
        id='ubuntu base',
    ...
    pytest.param(
        ...
        },
        {
            'device': ['cpu', 'hddl'],
            'python': 'python36',
            'dockerfile_name': 'openvino_ch_dev_2022.1.dockerfile',
            'tags': ['my_tag:latest'],
            'distribution': 'dev',
            'product_version': '2022.1',
        },
